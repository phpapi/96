...
$num=$empire->gettotal("select count(*) as total from www_96kaifa_com_ecms_game  where title like '%$word%'");
?>
<!doctype html>
<!DOCTYPE html>
<html lang="zh-CN">
...
<?php }else{
$Page_size=20; 
$result=$empire->query("select * from www_96kaifa_com_ecms_game where title like '%$word%'");
...
$sql=$empire->query("select * from www_96kaifa_com_ecms_game where title like '%$word%' order by newstime desc limit $offset,$Page_size");
