...
$num = 0;
if ($word != ''){
    $num=$empire->gettotal("select count(*) as total from www_96kaifa_com_ecms_qipailei  where title like '%$word%'");
}
  ...
  <div class="container">
    <div class="result">
      <div class="result-tab">
        <ul>
          <li class="tab_2"><a href="/search/qipailei.php?key=<?=$word?>">棋牌</a><i></i></li>
...
<?php }else{
$Page_size=20; 
$result=$empire->query("select * from www_96kaifa_com_ecms_qipailei where title like '%$word%'");
...
$sql=$empire->query("select * from www_96kaifa_com_ecms_qipailei where title like '%$word%' order by newstime desc limit $offset,$Page_size");
...
$key.="<a href=\"/search/qipailei.php?key=".$word."&page=".($page-1)."\" class=\"a1\">上一页</a>"; //上一页
}else { 
$key.="";//首页 
$key.=""; //上一页 
} 
...
$key.=" <a href=\"/search/qipailei.php?key=".$word."&page=".$i."\" class=\"a1\">".$i."</a>";
} 
} 
if($page!=$pages){ 


$key.=" <a href=\"/search/qipailei.php?key=".$word."&page=".($page+1)."\" class=\"a1\">下一页</a> ";//下一页
