...
if($row[fenlei]==1){$fenlei="益智";}
else if($row[fenlei]==2){$fenlei="动作";}
else if($row[fenlei]==3){$fenlei="射击";}
else if($row[fenlei]==4){$fenlei="休闲";}
else if($row[fenlei]==5){$fenlei="敏捷";}
else if($row[fenlei]==6){$fenlei="棋牌";}
else if($row[fenlei]==7){$fenlei="经营";}
else if($row[fenlei]==8){$fenlei="体育";}
else if($row[fenlei]==9){$fenlei="策略";}
else if($row[fenlei]==10){$fenlei="冒险";}
else if($row[fenlei]==11){$fenlei="装扮";}
?> 		
          <li>
            ...
            <div class="con"> <a href="<?php echo $row['titleurl']?>" target="_blank" class="title"><?php echo $row['title']?></a>
              <p><a href="/list-<?php echo $row['fenlei']?>-0-0-1.html" target="_blank"><?=$fenlei?></a><span>|</span><?php echo $row['onclick']?>人在玩</p>
...
if($page!=1){ 
//$key.="<a href=\"/search/danji.php?key=".$word."&page=1"."\" class=\"a1\">首页</a> "; //首页 
$key.="<a href=\"/search/danji.php?key=".$word."&page=".($page-1)."\" class=\"a1\">上一页</a>"; //上一页 
}else { 
$key.="";//首页 
$key.=""; //上一页 
} 
...
$key.=" <a href=\"/search/danji.php?key=".$word."&page=".$i."\" class=\"a1\">".$i."</a>"; 
} 
} 
if($page!=$pages){ 


$key.=" <a href=\"/search/danji.php?key=".$word."&page=".($page+1)."\" class=\"a1\">下一页</a> ";//下一页 
//$key.=" <a href=\"/search/danji.php?key=".$word."&page=".$pages."\" class=\"a1\">尾页</a>"; //尾页 
}else { 
$key.=" ";//下一页 
$key.=""; //尾页 
} 
