...
<?php }else{
$Page_size=20; 
$result=$empire->query("select * from www_96kaifa_com_ecms_majiang where title like '%$word%'");
...
$sql=$empire->query("select * from www_96kaifa_com_ecms_majiang where title like '%$word%' order by newstime desc limit $offset,$Page_size");
