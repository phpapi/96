...
function() {
	...
	function(t, e) {
		"function" == typeof define && define.amd ? define(["classie/classie", "get-style-property/get-style-property", "get-size/get-size", "unidragger/unidragger"], function(n, i, o, r) {
			return e(t, n, i, o, r)
		...
		s(a.prototype, o.prototype), a.defaults = {}, a.prototype.option = function(t) {
			...
			"relative" != t.position && "absolute" != t.position && (this.element.style.position = "absolute"), this.enable(), this.setHandles()
