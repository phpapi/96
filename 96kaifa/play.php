  ...
  <div class="gamesite">
    <div class="sitewrap">
      ...
      <div class="sitebody">
        <div class="body-nav">
          <ul>
            <li class="now" id="switch3" onclick="setTab('switch',3,4)">礼包</li>
            <li id="switch1" onclick="setTab('switch',1,4)">游戏</li>
        ...
        <div class="body-con" id="body-con">
          <div id="con_switch_3">
            <ul class="game-list s">
              <li> <a class="game-tit" href="http://www.3500.com/libao/421.html" target="_blank">
                <p class="name">点点大富翁独家礼包</p>
                <div class="wcd_pro">
                  <div class="wcd">
                    <div class="aqjc_progress"><span style="width:78%;"></span></div>
                    <em>剩余78%</em> </div>
                </div>
                </a> <a href="javascript:;" class="play-btn opencode" id="421">领取</a> </li>
              <li> <a class="game-tit" href="http://www.3500.com/libao/420.html" target="_blank">
                <p class="name">点点大富翁豪华礼包</p>
                <div class="wcd_pro">
                  <div class="wcd">
                    <div class="aqjc_progress"><span style="width:82%;"></span></div>
                    <em>剩余82%</em> </div>
                </div>
                </a> <a href="javascript:;" class="play-btn opencode" id="420">领取</a> </li>
              <li> <a class="game-tit" href="http://www.3500.com/libao/419.html" target="_blank">
                <p class="name">点点大富翁新手礼包</p>
                <div class="wcd_pro">
                  <div class="wcd">
                    <div class="aqjc_progress"><span style="width:83%;"></span></div>
                    <em>剩余83%</em> </div>
                </div>
                </a> <a href="javascript:;" class="play-btn opencode" id="419">领取</a> </li>
            </ul>
          </div>
          <div id="con_switch_1" style="display:none;">
...
$query = $empire->query("select * from www_96kaifa_com_ecms_game order by newstime limit 2");
...
<?php } ?>
            ...
            <ul class="game-list">
<?php 
$query = $empire->query("select * from www_96kaifa_com_ecms_game order by onclick limit 8");
while($rs = $empire->fetch($query)){
$xwtitle=$rs['title'];
$titleurl=$rs['titleurl'];
$yijuhua=$rs['yijuhua'];
    ...
    <div class="popupBox" id="popup">
      ...
      <div class="popdiv quitdiv" id="quit">
        ...
        <div class="quit-footer">
          <p class="quitp"><a class="quitbtn" href="/"><span class="left"></span><span class="right"></span>离开游戏</a></p>
          <label for="backnotip">
