...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_enewspostserver`;");
E_C("CREATE TABLE `www_96kaifa_com_enewspostserver` (
...
E_D("replace into `www_96kaifa_com_enewspostserver` values('1',0xe99984e4bbb6e69c8de58aa1e599a8,'','1','','','','','','0','0','0','0','0');");
