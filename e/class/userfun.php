...
function user_ShowFieldandChange($ecms=0){
	...
	if ($ecms == '1'){
        ...
        $fieldandval['fenlei']='|==|全部,##斗地主,1##跑胡子,2##21点,3##保皇,4##打滚子,5##干瞪眼,6##打大A,7##四冲,8##三代,9##5十K,10##三打一,11##挖坑,12##拱猪,13##红五,14##黑尖,15##攉龙,16##大怪路子,17##掼蛋,18##包分,19##拖拉机,20##接龙,21##跑得快,22##锄大地,23##梭哈,24##德州扑克,25##炸金花,26##够级,27##纸牌,28##牌九,29##十三张,30##刨幺,31##升级,32##三公,33##尖子顶,34##花牌,35##红十,36##斗牛,37';
    }else{
