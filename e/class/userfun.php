...
function user_ShowFieldandChange($ecms=0){
	...
	$fieldandval=array();
	if ($ecms == '1'){
        $fieldandval['fenlei']='|==|全部,##二人麻将,1##三人麻将,2##四人麻将,3##日本麻将,4##贵阳麻将,5##台湾麻将,6##上海麻将,7##四川麻将,8##北京麻将,9##广东麻将,10##陕西麻将,11##南昌麻将,12##长沙麻将,13##长春麻将,14##武汉麻将,15##山东麻将,16##宁波麻将,17##合肥麻将,18##河北麻将,19##天津麻将,20##太原麻将,21##福州麻将,22##杭州麻将,23##南京麻将,24##大连麻将,25##芜湖麻将,26##淮安麻将,27##南宁麻将,28##沈阳麻将,29##西安麻将,30##红中麻将,31##麻将接龙,32';
    }elseif ($ecms == '2'){
        $fieldandval['fenlei']='|==|全部,##斗地主,1##跑胡子,2##21点,3##保皇,4##打滚子,5##干瞪眼,6##打大A,7##四冲,8##三代,9##5十K,10##三打一,11##挖坑,12##拱猪,13##红五,14##黑尖,15##攉龙,16##大怪路子,17##掼蛋,18##包分,19##拖拉机,20##接龙,21##跑得快,22##锄大地,23##梭哈,24##德州扑克,25##炸金花,26##够级,27##纸牌,28##牌九,29##十三张,30##刨幺,31##升级,32##三公,33##尖子顶,34##花牌,35##红十,36##斗牛,37##捕鱼,38##桥牌,39##长牌,40##歪胡子,41##大字牌,42##大贰,43';
    }else{
...
function user_ShowFieldandChange11($ecms=0){
    global $public_r;
    ...
    //字段与字段的显示间隔符，格式：开始显示字符|结束显示字符
    $fieldexp='<dl class="clearfix_x"><dd>|</dd> </dl>';
