...
<?php
if($navinfor[fenlei]==1){$fenlei="卡牌游戏";}
else if($navinfor[fenlei]==2){$fenlei="角色扮演";}
else if($navinfor[fenlei]==3){$fenlei="模拟经营";}
else if($navinfor[fenlei]==4){$fenlei="射击游戏";}
else if($navinfor[fenlei]==5){$fenlei="动作游戏";}
else if($navinfor[fenlei]==6){$fenlei="战争策略";}
else if($navinfor[fenlei]==7){$fenlei="棋牌游戏";}
else if($navinfor[fenlei]==8){$fenlei="休闲游戏";}
?>
