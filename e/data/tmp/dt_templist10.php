...
<html lang="zh-CN">
<?php
if(ehtmlspecialchars($_GET[fenlei])==1){$fenlei="卡牌游戏";}
else if(ehtmlspecialchars($_GET[fenlei])==2){$fenlei="角色扮演";}
else if(ehtmlspecialchars($_GET[fenlei])==3){$fenlei="模拟经营";}
else if(ehtmlspecialchars($_GET[fenlei])==4){$fenlei="射击游戏";}
else if(ehtmlspecialchars($_GET[fenlei])==5){$fenlei="动作游戏";}
else if(ehtmlspecialchars($_GET[fenlei])==6){$fenlei="战争策略";}
else if(ehtmlspecialchars($_GET[fenlei])==7){$fenlei="棋牌游戏";}
else if(ehtmlspecialchars($_GET[fenlei])==8){$fenlei="休闲游戏";}
$fenlid=ehtmlspecialchars($_GET[fenlei]);
?>
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<title><?php if(ehtmlspecialchars($_GET[fenlei])==0){ ?>最新H5游戏_最新手机页游大全<?php }else{ ?><?=$fenlei?><?php } ?> - <?=$public_r['add_www_96kaifa_com_name']?></title>
...
<script type="text/javascript">
	showMobile("<?=$public_r['add_www_96kaifa_com_murl']?>/game/");
</script>
<body>
<div class="cover"></div>
<div class="topbox">
...
<?=user_ShowFieldandChange()?>
    <dl class="clearfix m-list-paixu">
      <dt>排序>></dt>
      <dd><a href="javascript:Filter('o','0')" class="on">最新</a><a href="javascript:Filter('o','0')">最热</a></dd>
    </dl>
  </div>
  <div class="game-ku">
...
[!--empirenews.listtemp--]
    ...
    <div class="page"> [!--show.pagejiehes--] </div>
  </div>
</div>
<div id="footer">
...
<script type="text/javascript" src="/96kaifa/statics/home/js/orderby.js"></script>
