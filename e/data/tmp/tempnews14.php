...
else if($navinfor[fenlei]==9){$fenlei="qq三代";}
...
else if($bqr[fenlei]==9){$bfenlei="qq三代";}
...
conf: 'prod_8e11cfb50c20f2a0b31d59926e9e42c7'
    ...
    <div class="w336">
      <div class="w-kftab">
        ...
        <div class="tab_con">
          <p class="p_th"> <span class="time">日期</span> <span class="name">游戏名称</span> <span class="server">服务器名</span> </p>
          <ul class="clearfix">
<?php $ktime=date('Y-m-d'); ?>
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from www_96kaifa_com_ecms_kaifu where kfsj like '%$ktime%' order by kfsj desc limit 5",6,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
<?php 
$num50=$empire->gettotal("select count(*) as total from www_96kaifa_com_ecms_kaifu where kfsj like '%$ktime%' order by kfsj desc limit 5");
$num40=5-$num50;
if($num40<0){$num40=0;}
?>
<?php
