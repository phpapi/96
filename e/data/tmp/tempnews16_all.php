...
<?php
if($navinfor[fenlei]==1){$fenlei="五子棋";}
else if($navinfor[fenlei]==2){$fenlei="象棋";}
else if($navinfor[fenlei]==3){$fenlei="围棋";}
else if($navinfor[fenlei]==4){$fenlei="飞行棋";}
else if($navinfor[fenlei]==5){$fenlei="中国暗棋";}
else if($navinfor[fenlei]==6){$fenlei="跳棋";}
else if($navinfor[fenlei]==7){$fenlei="井字棋";}
else if($navinfor[fenlei]==8){$fenlei="军棋";}
else if($navinfor[fenlei]==9){$fenlei="斗兽棋";}
else if($navinfor[fenlei]==10){$fenlei="将棋";}
else if($navinfor[fenlei]==11){$fenlei="四子棋";}
else if($navinfor[fenlei]==12){$fenlei="大富翁";}
else if($navinfor[fenlei]==13){$fenlei="国际象棋";}
?>
      <p class="pinfo"><a href="/list-<?=$ecms_gr[fenlei]?>-0-0-4.html" target="_blank"><?=$fenlei?></a><span>|</span><script src="/e/public/ViewClick/?classid=<?=$ecms_gr[classid]?>&id=<?=$ecms_gr[id]?>&addclick=1"></script>人在玩</p>
