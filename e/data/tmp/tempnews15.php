...
<?php
if($navinfor[fenlei]==1){$fenlei="二人麻将";}
else if($navinfor[fenlei]==2){$fenlei="三人麻将";}
else if($navinfor[fenlei]==3){$fenlei="四人麻将";}
else if($navinfor[fenlei]==4){$fenlei="日本麻将";}
else if($navinfor[fenlei]==5){$fenlei="贵阳麻将";}
else if($navinfor[fenlei]==6){$fenlei="台湾麻将";}
else if($navinfor[fenlei]==7){$fenlei="上海麻将";}
else if($navinfor[fenlei]==8){$fenlei="四川麻将";}
else if($navinfor[fenlei]==9){$fenlei="北京麻将";}
else if($navinfor[fenlei]==10){$fenlei="广东麻将";}
else if($navinfor[fenlei]==11){$fenlei="陕西麻将";}
else if($navinfor[fenlei]==12){$fenlei="南昌麻将";}
else if($navinfor[fenlei]==13){$fenlei="长沙麻将";}
else if($navinfor[fenlei]==14){$fenlei="长春麻将";}
else if($navinfor[fenlei]==15){$fenlei="武汉麻将";}
else if($navinfor[fenlei]==16){$fenlei="山东麻将";}
else if($navinfor[fenlei]==17){$fenlei="宁波麻将";}
else if($navinfor[fenlei]==18){$fenlei="合肥麻将";}
else if($navinfor[fenlei]==19){$fenlei="河北麻将";}
else if($navinfor[fenlei]==20){$fenlei="天津麻将";}
else if($navinfor[fenlei]==21){$fenlei="太原麻将";}
else if($navinfor[fenlei]==22){$fenlei="福州麻将";}
else if($navinfor[fenlei]==23){$fenlei="杭州麻将";}
else if($navinfor[fenlei]==24){$fenlei="南京麻将";}
else if($navinfor[fenlei]==25){$fenlei="大连麻将";}
else if($navinfor[fenlei]==26){$fenlei="芜湖麻将";}
else if($navinfor[fenlei]==27){$fenlei="淮安麻将";}
else if($navinfor[fenlei]==28){$fenlei="南宁麻将";}
else if($navinfor[fenlei]==29){$fenlei="沈阳麻将";}
else if($navinfor[fenlei]==30){$fenlei="西安麻将";}
else if($navinfor[fenlei]==31){$fenlei="红中麻将";}
else if($navinfor[fenlei]==32){$fenlei="麻将接龙";}

?>
      <p class="pinfo"><a href="/list-<?=$ecms_gr[fenlei]?>-0-0-3.html" target="_blank"><?=$fenlei?></a><span>|</span><script src="/e/public/ViewClick/?classid=<?=$ecms_gr[classid]?>&id=<?=$ecms_gr[id]?>&addclick=1"></script>人在玩</p>
