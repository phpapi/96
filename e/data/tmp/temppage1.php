...
<div class="main">
  ...
  <div class="fowarp">
    <div class="wrap-bar">
      <ul>
        <li><a href="/aboutus.html" class="current"><span><i class="gywm"></i>关于我们</span></a></li>
    ...
    <div class="wrap-con">
      ...
      <div class="con">
        <p>　　<?=$public_r['add_www_96kaifa_com_name']?>游戏平台拥有国内最资深的手机页游媒体团队，目前为止已经拥有大量的手机页游用户，网站内容涵盖了苹果手机页游、安卓手机页游、发号中心、手机页游社区，为所有手机页游用户提供最完美的体验，目标成为全国最专业的手机页游媒体平台。</p>
        <p>　　为玩家提供最全最新的苹果、安卓等等设备手机页游的游戏新闻、活动、攻略、游戏评测、H5游戏，打造一个完美的用户体验平台，同时为了打造一个更好的服务环境，从而依托手机页游社区，为玩家提供一个最佳的交流探讨环境，打造一个最佳体验的手机页游媒体平台。</p>
      </div>
    </div>
    <div class="clear"></div>
  </div>
