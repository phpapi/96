...
<?php
if($navinfor[fenlei]==1){$fenlei="斗地主";}
else if($navinfor[fenlei]==2){$fenlei="跑胡子";}
else if($navinfor[fenlei]==3){$fenlei="21点";}
else if($navinfor[fenlei]==4){$fenlei="保皇";}
else if($navinfor[fenlei]==5){$fenlei="打滚子";}
else if($navinfor[fenlei]==6){$fenlei="干瞪眼";}
else if($navinfor[fenlei]==7){$fenlei="打大A";}
else if($navinfor[fenlei]==8){$fenlei="四冲";}
else if($navinfor[fenlei]==9){$fenlei="三代";}
else if($navinfor[fenlei]==10){$fenlei="5十K";}
else if($navinfor[fenlei]==11){$fenlei="三打一";}
else if($navinfor[fenlei]==12){$fenlei="挖坑";}
else if($navinfor[fenlei]==13){$fenlei="拱猪";}
else if($navinfor[fenlei]==14){$fenlei="红五";}
else if($navinfor[fenlei]==15){$fenlei="黑尖";}
else if($navinfor[fenlei]==16){$fenlei="攉龙";}
else if($navinfor[fenlei]==17){$fenlei="大怪路子";}
else if($navinfor[fenlei]==18){$fenlei="掼蛋";}
else if($navinfor[fenlei]==19){$fenlei="包分";}
else if($navinfor[fenlei]==20){$fenlei="拖拉机";}
else if($navinfor[fenlei]==21){$fenlei="接龙";}
else if($navinfor[fenlei]==22){$fenlei="跑得快";}
else if($navinfor[fenlei]==23){$fenlei="锄大地";}
else if($navinfor[fenlei]==24){$fenlei="梭哈";}
else if($navinfor[fenlei]==25){$fenlei="德州扑克";}
else if($navinfor[fenlei]==26){$fenlei="炸金花";}
else if($navinfor[fenlei]==27){$fenlei="够级";}
else if($navinfor[fenlei]==28){$fenlei="纸牌";}
else if($navinfor[fenlei]==29){$fenlei="牌九";}
else if($navinfor[fenlei]==30){$fenlei="十三张";}
else if($navinfor[fenlei]==31){$fenlei="刨幺";}
else if($navinfor[fenlei]==32){$fenlei="升级";}
else if($navinfor[fenlei]==33){$fenlei="三公";}
else if($navinfor[fenlei]==34){$fenlei="尖子顶";}
else if($navinfor[fenlei]==35){$fenlei="花牌";}
else if($navinfor[fenlei]==36){$fenlei="红十";}
else if($navinfor[fenlei]==37){$fenlei="斗牛";}
else if($navinfor[fenlei]==38){$fenlei="捕鱼";}
else if($navinfor[fenlei]==39){$fenlei="桥牌";}
else if($navinfor[fenlei]==40){$fenlei="长牌";}
else if($navinfor[fenlei]==41){$fenlei="歪胡子";}
else if($navinfor[fenlei]==42){$fenlei="大字牌";}
else if($navinfor[fenlei]==43){$fenlei="大贰";}
?>
      <p class="pinfo"><a href="/list-<?=$ecms_gr[fenlei]?>-0-0-2.html" target="_blank"><?=$fenlei?></a><span>|</span><script src="/e/public/ViewClick/?classid=<?=$ecms_gr[classid]?>&id=<?=$ecms_gr[id]?>&addclick=1"></script>人在玩</p>
...
<div class="pcode"><img src="/96kaifa/statics/home/images/wx.jpg"><span>手机扫描 马上玩</span></div>
  </div>
  <div class="game-container">
    <div class="w804">
      <div class="game-jianjie">
          <h2><?=$ecms_gr[title]?>游戏简介</h2>
...
<div class="The_game">
<h2><?=$ecms_gr[title]?>游戏亮点</h2>
 <?=$ecms_gr[liangdian]?>
</div>
<div class="gameplay">
  <h2><?=$ecms_gr[title]?>游戏玩法</h2>
 <?=$ecms_gr[wanfa]?>
</div>
 </div>
...
?>
      ...
      <div class="h_comment" id="comment_box" data="comment-163-1">
        ...
        <div>
          <!--PC版-->
<div id="SOHUCS" ></div>
<script charset="utf-8" type="text/javascript" src="/96kaifa/statics/home/js/newcy.js" ></script>
<script type="text/javascript">
...
?>
            <li> <em class="num num<?=$bqno?>"><?=$bqno?></em>
              <div class="box1">
                ...
                <p><span><?=$bfenlei?></span><span><?=$bqr['onclick']?>人在玩</span></p>
              </div>
