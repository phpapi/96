...
<div class="main">
  <div class="position">当前位置：<a href="/">首页</a> > 用户协议</div>
  <div class="fowarp">
    <div class="wrap-bar">
      <ul>
        ...
        <li><a href="/explain.html" class="current"><span><i class="yhxy"></i>用户协议</span></a></li>
      </ul>
    </div>
    <div class="wrap-con">
      ...
      <div class="con">
        ...
        <p>七、网站文章仅代表作者本人观点，与本站立场无关。<a href="https://www.96kaifa.com" target="_blank">网站模板</a>如有转载的文章请注明出处或原作者，否则引起的版权纠纷与本网站无关。</p>
        <p>八、凡以任何方式访问本站或直接、间接使用网站信息者，视为自愿接受网站免责声明的约束。</p>
        <p>九、用户注册账号后如果长期不使用，有权收回帐号，以免造成资源浪费，由此带来的包括并不限于用户资料、邮件和游戏虚拟道具丢失等损失由用户自行承担。</p>
        <p>十、本免责条款以及其修改权、更新权及最终解释权均属游戏平台所有。</p>
      </div>
    </div>
    <div class="clear"></div>
  </div>
