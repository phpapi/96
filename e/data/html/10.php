...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>分类</td><td bgcolor='ffffff'><select name="fenlei" id="fenlei"><option value="1"<?=$r[fenlei]=="1"?' selected':''?>>益智</option><option value="2"<?=$r[fenlei]=="2"?' selected':''?>>动作</option><option value="3"<?=$r[fenlei]=="3"?' selected':''?>>射击</option><option value="4"<?=$r[fenlei]=="4"?' selected':''?>>休闲</option><option value="5"<?=$r[fenlei]=="5"?' selected':''?>>敏捷</option><option value="6"<?=$r[fenlei]=="6"?' selected':''?>>棋牌</option><option value="7"<?=$r[fenlei]=="7"?' selected':''?>>经营</option><option value="8"<?=$r[fenlei]=="8"?' selected':''?>>体育</option><option value="9"<?=$r[fenlei]=="9"?' selected':''?>>策略</option><option value="10"<?=$r[fenlei]=="10"?' selected':''?>>冒险</option><option value="11"<?=$r[fenlei]=="11"?' selected':''?>>装扮</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>一句话</td><td bgcolor='ffffff'>
<input name="yijuhua" type="text" id="yijuhua" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[yijuhua]))?>" size="60">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏URL地址</td><td bgcolor='ffffff'>
<input name="yxurl" type="text" id="yxurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[yxurl]))?>" size="">
