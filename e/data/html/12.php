...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>开服时间</td><td bgcolor='ffffff'><input name="kfsj" type="text" id="kfsj" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[kfsj]))?>" size="30" class="Wdate" onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"><input type=button name=button value="设为当前时间" onclick="document.add.kfsj.value='<?=$todaytime?>'"></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>服务器</td><td bgcolor='ffffff'>
<input name="fuwuqi" type="text" id="fuwuqi" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[fuwuqi]))?>" size="">
