...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>相关游戏名字</td><td bgcolor='ffffff'>
<input name="xgname" type="text" id="xgname" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[xgname]))?>" size="">
...
</div><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>封面图片</td><td bgcolor='ffffff'>
